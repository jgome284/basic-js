...
// Test function on valid and invalid entries:
console.log(validateCred(valid1)); // Should print true
console.log(validateCred(invalid1)); // Should print false

// Create function that retreives input of batch arrays and uses validateCred as a callback
...
console.log(findInvalidCards(batch)); // Test all cards in batch, including mystery numbers
